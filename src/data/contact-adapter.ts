...
export function contactFromApi(raw: ApiClientResponse): Contact {
  ...
  return {
    ...
    countryId: emptyToUndefined(raw.country_id),
    ...
    deliveryCountryId: emptyToUndefined(raw.delivery_country_id),
    ...
    defaultDiscount:
      raw.discount !== null && raw.discount !== '' ? safeParseFloat(raw.discount, 'contact discount') : undefined,
    defaultDueDays:
      raw.due_date !== null && raw.due_date !== '' ? safeParseInt(raw.due_date, 'contact due days') : undefined,
